...
class Question2:
    def __init__(self, dimes_and_quarters=None):
        ...
        """
        # self.dimes_and_quarters = {'quarters' : 0, 'dimes' :0}
        # self.dimes_and_quarters = {}

        if dimes_and_quarters is None:
            self.dimes_and_quarters = {'quarters': 0, 'dimes':0}
        else:
            self.dimes_and_quarters['quarters'] = dimes_and_quarters.get('quarters', 0)
            self.dimes_and_quarters['dimes'] = dimes_and_quarters.get('dimes', 0)


        # if (dimes_and_quarters["quarters"] == None):
        #     self.dime_and_quarters['quarters'] = 0
        # else:
        #     self.dime_and_quarters['quarters'] = dimes_and_quarters["quarters"]
        #
        # if (dimes_and_quarters['dimes'] == None):
        #     self.dime_and_quarters['dimes'] = 0
        # else:
        #     self.dime_and_quarters['dimes'] = dimes_and_quarters['dimes']
    ...
    def add_coins(self, dimes_and_quarters):
        ...
        self.dimes_and_quarters['quarters'] = self.dimes_and_quarters['quarters'] + dimes_and_quarters.get('quarters', 0)
        self.dimes_and_quarters['dimes'] = self.dimes_and_quarters['dimes'] + dimes_and_quarters.get('dimes', 0)
